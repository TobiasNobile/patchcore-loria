"""Superpose la heatmap d'anomalie PatchCore sur des frames test armes-en-scène.

Charge une banque construite par bin/weapon/fit/memory_bank.py — pas de fit ni de
...
bin/live_web.py affichera en direct sur la webcam.
    ...
    python bin/weapon/infer/heatmap.py                      # une frame (défaut)
    python bin/weapon/infer/heatmap.py --image_index 50     # une autre frame
    python bin/weapon/infer/heatmap.py --n_per_class 30     # 30 weapon + 30 good
"""
import logging
import os
import platform
...
OUTPUT_PATH = "results/weapon/heatmaps/overlay_idx{idx}.png"
...
def main(image_index, n_per_class):
    ...
    if n_per_class > 0:
        ...
        out_dir = os.path.join(
            os.path.dirname(OUTPUT_PATH) or "results/weapon/heatmaps",

...
# On rapatrie la base + ses artefacts dans un dossier temporaire, puis
# mlflow_import.py re-crée les runs dans mlruns.db (params, metrics, tags,
# artefacts) en régénérant les chemins locaux. Plus de base parallèle, plus de
# réécriture sqlite fragile. Idempotent : réimporter n'ajoute pas de doublon.
